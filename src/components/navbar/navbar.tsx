                  ...
                  {navigationLinks.map((link, index) => {
                    ...
                    return (
                      <NavigationMenuItem key={index} className="w-full">
                        <NavigationMenuLink
                          href={link.href}
                          className="py-1.5 flex items-center gap-2 flex-row hover:[&>svg]:text-[var(--accent-foreground)]"
                          active={isActive}
                        >
                          <IconComponent
                            size={16}
                ...
                {navigationLinks.map((link, index) => {
                  ...
                  return (
                    <NavigationMenuItem key={index}>
                      <NavigationMenuLink
                        href={link.href}
                        className="text-muted-foreground hover:text-primary py-1.5 font-medium flex items-center gap-2 flex-row hover:[&>svg]:text-[var(--accent-foreground)]"
                        active={isActive}
                      >
                        <IconComponent
                          size={16}
